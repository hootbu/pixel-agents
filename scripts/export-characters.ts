 ...
 * webview-ui/public/assets/characters/. Each PNG is 144×72:
 *   - 9 frames horizontally (16×24 each) = 144px wide
 *   - 3 direction rows vertically (24px each) = 72px tall
 *     Row 0 = down, Row 1 = up, Row 2 = right
 *
 * Frame order per row: idle1, idle2, walk1, walk2, walk3, type1, type2, read1, read2
 *
...
console.log('\nPNG layout:')
console.log('  144×96 (9 frames × 16px wide, 3 rows × 32px tall)')
...
console.log('\nFrame order (per row):')
console.log('  0: idle_1, 1: idle_2, 2: walk_1, 3: walk_2, 4: walk_3, 5: type_1, 6: type_2, 7: read_1, 8: read_2')
